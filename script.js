...
<div class="book-action-links">
    ...
    ${b.pdfUrl ? `<a href="${b.pdfUrl}" target="_blank" class="btn-small btn-edit">Download PDF</a>` : ''}
    ${b.epubUrl ? `<a href="${b.epubUrl}" target="_blank" class="btn-small btn-edit">Download EPUB</a>` : ''}
</div>
            </div>
        </div>
    `;
